...
func getMigrations() []migration {
	return []migration{
		getCreateUserTable(),
		getCreateRefreshTokensTable(),
		getCreateProjectsTable(),
		getCreateProjectMembersTable(),
		getCreateSprintsTable(),
		getCreateEpicsTable(),
		getCreateIssueTypesTable(),
		getCreatePrioritiesTable(),
		getCreateStatusesTable(),
		getCreateLabelsTable(),
		getCreateIssuesTable(),
		getCreateIssueLabelsTable(),
		getCreateCommentsTable(),
		getCreateWorklogsTable(),
		getCreateAttachmentsTable(),
		getCreateIssueLinksTable(),
		getCreateIssueHistoryTable(),
		getCreateNotificationsTable(),
		getAlterUserTableAddAvatarUrl(),
		getAlterUserTableAddStatus(),
		getCreateEmailVerif(),
	}
}

func checkDuplicateMigrationNames(migration []migration) {
